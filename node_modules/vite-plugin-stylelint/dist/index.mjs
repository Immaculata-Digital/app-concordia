import { a as lintFiles, i as initializeStylelint, n as getFilter, o as shouldIgnoreModule, r as getOptions, s as PLUGIN_NAME, t as getFilePath } from "./utils-BOx7YRBn.mjs";
...
function StylelintPlugin(userOptions = {}) {
	...
	return {
		...
		async transform(_, id) {
			...
			const filteredIds = ids.filter((id$1) => !shouldIgnoreModule(id$1, filter));
			debug(`filteredIds: ${filteredIds}`);
			const shouldIgnore = filteredIds.length === 0;
			debug(`should ignore: ${shouldIgnore}`);
			if (shouldIgnore) return;
			const filePaths = filteredIds.map((id$1) => getFilePath(id$1));
