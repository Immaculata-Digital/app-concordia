...
import type { MenuDefinition } from './menus'
...
const MENUS_KEY = 'marshall_menus'
...
export const authService = {
   ...
   */
  decodeToken(token: string): { permissions?: string[]; exp?: number; tenantId?: string } | null {
    try {
